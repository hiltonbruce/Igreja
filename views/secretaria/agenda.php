...
if ($_GET['imp']>'0') {
    ...
    $ano = (empty($_GET['ano'])) ? date ('Y'):$_GET['ano'];
        $templo = '<div style="background:#CCC;width:265%; text-align:left;">'.$templo.' - Agenda Secretaria - Calend&aacute;rio '.$ano.'<br /></div> ';
...
<body>
    ...
    */
    ...
    //  $todos = "1";
     ...
     $mes= "1"; else $mes=intval($_GET["mes"]);
    ...
    if (empty($_GET["ano"]))
      ...
      if ($_GET['imp']!='2') {
        switch ($mes) {
          case '11':
            echo gerarCalendario($mes,$y,2,$colunas,
                         array(array()),
                         $nome_igreja,/*Define o texto do Rodapé do calendário*/
                        "Santa Ceia"/*Define o texto da legenda*/,$dia_ceia,$semana_ceia);
            echo gerarCalendario(1,$y+1,1,$colunas,
                         array(array()),
                         $nome_igreja,/*Define o texto do Rodapé do calendário*/
                        "Santa Ceia"/*Define o texto da legenda*/,$dia_ceia,$semana_ceia);
            break;
          case '12':
            echo gerarCalendario($mes,$y,1,$colunas,
                         array(array()),
                         $nome_igreja,/*Define o texto do Rodapé do calendário*/
                        "Santa Ceia"/*Define o texto da legenda*/,$dia_ceia,$semana_ceia);
            echo gerarCalendario(1,$y+1,2,$colunas,
                         array(array()),
                         $nome_igreja,/*Define o texto do Rodapé do calendário*/
                        "Santa Ceia"/*Define o texto da legenda*/,$dia_ceia,$semana_ceia);
            break;
