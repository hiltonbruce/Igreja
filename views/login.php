    <div class="login">
      <figure class="highlight text-center">
          ...
          <h3 class="text-center">Administra&ccedil;&atilde;o de Igreja - SisADBy</h3>
        <pre>
        <h5>Fazer login para prosseguir</h5>
        <img data-holder-rendered="true"
        src="img/LOG_BAYEUX..jpg" style="width: 140px; height: 140px;" alt="140x140"
      ...
      class=""></li> <li class="active" data-target="#carousel-example-captions" data-slide-to="1">

      </li> <li class="" data-target="#carousel-example-captions" data-slide-to="2"></li> </ol>
      <div class="carousel-inner" role="listbox">
      <div class="item"><br />
      <img data-holder-rendered="true" src="img/marcaBkp.png" alt="900x500" width="500" data-src="holder.js/900x500/auto/#777:#777">
       <br /><br />
       <div class="carousel-caption">
       </div> </div>
       <div class="item active">
      <img data-holder-rendered="true" src="img/debian.png" alt="900x500" width="333" height="600" data-src="holder.js/900x500/auto/#666:#666">
      <div class="carousel-caption">
      <h3>Joseilton Costa Bruce</h3>
      <p>hiltonbruce@gmail.com</p>
      </div> </div>
      <div class="item">
      <img data-holder-rendered="true" src="img/lamp.png" alt="900x500" width="416" >
      <div class="carousel-caption">
      <h3></h3>
      <p></p>
      </div> </div> </div>
