		...
		<table class="table">
			<tbody>
				...
				<tr>
					...
					<td>
						<label>N&ordm;</label> <input name="numero" type="text"
				...
				<tr>
					<td>
						<label>Telefone:</label> <input name="fone_resid"
				...
				<tr>
					<td><label>Natural de:</label>
						...
						<td>
							...
							<input name="datanasc" type="text" class="form-control" id="data"
				...
				<td>
					<h6>Doador de Sangue?
					<label class="radio-inline"><input type='radio' name='doador' required="required"
							value='Sim' tabindex='<?PHP echo $ind++;?>' /> Sim</label>
							<label class="radio-inline"><input type='radio' name='doador' required="required"
							value='Não' tabindex='<?PHP echo $ind++;?>' /> N&atilde;o</label></h6>
				</td>
					<td>
						<label>Tipo</label> <select name='sangue'
						placeholder="Tipo Sanguínio" class="form-control"
						tabindex='<?PHP echo $ind++;?>'>
					...
					<select name="escolaridade"
						size="1" class="form-control" id="escolaridade" tabindex="<?PHP echo $ind++;?>">
							<option value=""></option>
				...
				<tr>
						<td>
							<label>Gradua&ccedil;&atilde;o:</label> <input
