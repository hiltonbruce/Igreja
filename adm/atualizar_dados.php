   ...
   if (mysql_num_rows($result)>0)
	{
		...
		print "<br \>O Campo foi atualizado de:<h3>{$rec->$_POST["campo"]()}</h3>\n"; //Imprime o valor na tela
			...
			if ($_POST["campo"]=="auxiliar" || $_POST["campo"]=="diaconato" ||  $_POST["campo"]=="presbitero" ||  $_POST["campo"]=="evangelista" ||  $_POST["campo"]=="pastor" ||  $_POST["campo"]=="datanasc" || $_POST["campo"]=="dt_nasc" ||  $_POST["campo"]=="dt_apresent" || $_POST["campo"]=="data" ||  $_POST["campo"]=="dat_aclam" ||  $_POST["campo"]=="batismo_em_aguas" || $_POST["campo"]=="c_entregue" || $_POST["campo"]=="c_impresso"  || $_POST["campo"]=="dt_mudanca_denominacao" ) {
