...
switch ($rec) {
	...
	case '3':
		...
		require_once('forms/ofertaEBD.php'); #Form lan�aar ofertas Esc B�blica
		break;
	case '4':
	...
	case '5':
		...
		$tabRelatorio = 'forms/tes/lancarTipoPlan.php'; #Form lan�ar despesas tipo planilha
		break;
	...
	case '11':
		...
		if (!empty($_GET['mes']) && empty($_GET['igreja'])) {
			...
			require_once 'views/tesouraria/cabTabFinPrint.php'; //Cabe�alho da tabela
	...
	case '27':
		...
		$referente = 'Contribui��o conven��o estadual, n/ m�s';
