...
<div class="rightpanel">
 ...
 <div class="header">
	...
	<?php 
		...
		<div class="box-inner">
		<div class="box-titulo">
		<table cellspacing="0" id="pendencia" >
		<caption id="pendencia">Rol's com Pend&ecirc;ncias</caption>
		...
		<?PHP
			...
			{			
			if ($inc_pen=="0") { echo "<tr id='pendencia'>"; }
			$inc_pen++;
			echo "<td id='pendencia' ><a title = '{$coluna_pen["nome"]}' href='./?escolha=adm/dados_pessoais.php&bsc_rol={$coluna_pen["rol"]}&pagina1_pen={$_GET["pagina1_pen"]}'>{$coluna_pen["rol"]}<a></td>";
	...
	echo " <div class='header'>Disciplinados</div>";
		...
		<div class="box-titulo">
		<table cellspacing="0" id="pendencia" >
		<caption id="pendencia">Rol's</caption>
		...
		<tbody id="pendencia" >
			...
			if ($array_exp["data_fim"]<date("Y-m-d") AND $array_exp["data_fim"]<>"0000-00-00") {
				echo "<td id='pendencia' ><a title = '{$membro_disc->nome()} - Disciplina Conclu&iacute;da' href='./?escolha=adm/dados_pessoais.php&bsc_rol={$coluna_disc["rol"]}&pagina1_disc={$_GET["pagina1_disc"]}'><span style='color:#009900'><blink>{$coluna_disc["rol"]}</blink></span><a></td>";
				$disp_pend++;
			}else {
				echo "<td id='pendencia' ><a title = '{$membro_disc->nome()}' href='./?escolha=adm/dados_pessoais.php&bsc_rol={$coluna_disc["rol"]}&pagina1_disc={$_GET["pagina1_disc"]}'>{$coluna_disc["rol"]}<a></td>";
			}
