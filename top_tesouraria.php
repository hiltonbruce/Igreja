...
<div id="tabs">
	<ul>
	  <li><a <?PHP id_corrente ("receita");?> href="./?escolha=tesouraria/receita.php&menu=top_tesouraria&rec=1"><span>Lançamentos</span></a></li>
	  <li><a <?PHP id_corrente ("despesa");?> href="./?escolha=tesouraria/despesa.php&menu=top_tesouraria&rec=1"><span>Despesas</span></a></li>
	  <li><a <?PHP id_corrente ("recibo");?> href="./?escolha=tesouraria/recibo.php&menu=top_tesouraria&rec=1"><span>Recibos</span></a></li>
