CREATE DATABASE  IF NOT EXISTS `assembleia` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `assembleia`;
-- MySQL dump 10.13  Distrib 5.5.33, for debian-linux-gnu (x86_64)
--
-- Host: Localhost    Database: assembleia
-- ------------------------------------------------------
...
INSERT INTO `funcao` VALUES (1,'Dirigente de Congregação',1,'2272: Jailton Costa Bruce','2009-10-08 02:35:42'),(2,'Professor do CETAD',1,'2272: Jailton Costa Bruce','2009-10-08 02:43:26'),(3,'Professor de Escola Bíblica',1,'2272: Jailton Costa Bruce','2009-10-08 02:43:41'),(4,'Dirigente de Mocidade',1,'2272: Jailton Costa Bruce','2009-10-08 02:44:17'),(5,'Superintendente de Escola Bíblica',1,'2272: Jailton Costa Bruce','2009-10-08 02:45:17'),(6,'Dirigente de Circulo de Oração',1,'2272: Jailton Costa Bruce','2009-10-08 02:45:49'),(7,'Secretário',1,'2272: Jailton Costa Bruce','2009-10-08 02:51:24'),(8,'Tesoureiro',1,'2272: Jailton Costa Bruce','2014-03-08 02:19:51'),(9,'Porteiro',1,'2272: Jailton Costa Bruce','2009-10-08 02:52:04'),(10,'Dirigente de Circulo de Oração Infantil',1,'2272: Jailton Costa Bruce','2009-10-08 02:59:41'),(11,'Dirigente de Circulo de Oração de Mocidade',1,'2272: Jailton Costa Bruce','2009-10-08 03:00:06'),(12,'Zelador(a)',1,'2272: Jailton Costa Bruce','2009-10-08 03:00:40'),(13,'Pastor da Cidade',1,'2272: Jailton Costa Bruce 	','2014-03-01 03:05:42'),(14,'Auxílio Social',0,'Joseilton','2014-05-05 15:11:57'),(15,'Tesoureiro de Missões',1,'Joseilton','2014-07-04 22:09:43'),(16,'Secretário de Missões',1,'Joseilton','2014-07-04 22:09:53'),(17,'Ministério',1,'Joseilton','2014-07-04 22:08:05'),(18,'Mestre de Obras',1,'Joseilton','2014-07-04 22:08:05'),(19,'Pedreiro',1,'Joseilton','2014-07-04 22:08:33'),(20,'Servente de Pedreiro',1,'Joseilton','2014-07-04 22:08:33'),(21,'Vigia',0,'Joseilton','2014-07-12 23:03:08'),(22,'Tesoureiro Geral',1,'Joseilton','2014-07-13 22:33:02'),(23,'Manuteção predial',1,'','2014-10-16 00:59:06'),(24,'Auxiliar de Serviços',1,'','2014-10-16 01:01:47');
...
CREATE TABLE `lanc` (
  ...
  `referente` varchar(500) NOT NULL COMMENT 'Histórico do lançamento',
  `data` date NOT NULL,
  `hist` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `limpeza` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `discrim` (`discrim`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=latin1 COMMENT='Lista de material de limpeza disponível para entrega';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `limpeza` VALUES (1,'Água sanitária','litros',2,2,'2013-01-29 03:18:19','Joseilton'),(2,'Balde 5 litros','Unid',1,4,'2013-01-29 03:18:19','Joseilton'),(3,'Balde grande','unid',1,4,'2013-01-30 04:08:38','Joseilton'),(5,'Cera liquida incolor','unid',1,2,'2013-01-30 04:27:44','Joseilton'),(6,'Cera vermelha','unid',1,2,'2013-01-30 04:27:44','Joseilton'),(7,'Cesto de lixo','unid',1,2,'2013-01-29 06:00:00','Joseilton'),(8,'Cesto de lixo grande','unid',1,2,'2013-01-29 06:00:00','Joseilton'),(9,'Cloro','litros',2,2,'2013-01-30 04:31:06','Joseilton'),(10,'Desinfetante','litros',2,2,'2013-01-29 06:00:00','Joseilton'),(11,'Destac p/ piso','unid',1,2,'2013-01-30 04:32:10','Joseilton'),(12,'Detergente','Militros',200,2,'2013-01-30 04:32:10','Joseilton'),(13,'Espanador','unid',1,3,'2013-01-30 04:32:42','Joseilton'),(14,'Esponja','unid',1,2,'2013-01-30 04:32:42','Joseilton'),(15,'Flanela','unid',1,2,'2013-01-30 04:33:16','Joseilton'),(16,'Limpa vidro - refil','ml',500,2,'2013-01-30 04:33:16',''),(17,'Lustra móveis','ml',200,2,'2013-01-30 04:34:34','Joseilton'),(18,'Luva emborrachada','par',1,2,'2013-01-30 04:34:34','Joseilton'),(19,'Mangueira','m',25,12,'2013-01-30 04:35:50','Joseilton'),(20,'Óleo de peroba','unid',1,2,'2013-01-30 04:35:50','Joseilton'),(21,'Pá','unid',1,6,'2013-01-30 04:36:33','Joseilton'),(22,'Palha de aço','pc',1,2,'2013-01-30 04:36:33','Joseilton'),(23,'Pano de chão','unid',1,6,'2013-01-30 04:37:05','Joseilton'),(24,'Pano de prato','unid',1,6,'2013-01-30 04:37:05','Joseilton'),(25,'Papel higiênico','pc c/ 4 unid',1,2,'2013-01-30 04:37:46','Joseilton'),(26,'Pastilha para banheiro','unid',1,2,'2013-01-30 04:37:46','Joseilton'),(27,'Pinho sol','Litro',1,2,'2013-01-30 04:38:22','Joseilton'),(28,'Querosene','ml',200,2,'2013-01-30 04:38:22','Joseilton'),(29,'Rodo','unid',1,6,'2013-01-30 04:38:55','Joseilton'),(30,'Sabão de coco','unid',1,2,'2013-01-30 04:38:55','Joseilton'),(31,'Sabão de pedra','unid',1,2,'2013-01-30 04:39:22','Joseilton'),(32,'Sabão em pó Ala ou Bem-te-vi','g',500,2,'2013-01-30 04:39:22','Joseilton'),(33,'Sabão líquido','Litro',1,2,'2013-01-30 04:40:26','Joseilton'),(34,'Sabonete','g',90,2,'2013-01-30 04:40:26','Joseilton'),(35,'Saco de lixo - 100 litros','pc c/ 5 unid',1,2,'2013-01-30 04:41:49','Joseilton'),(36,'Saco de lixo - 30 litros','pc c/ 5 unid',1,2,'2013-01-30 04:41:49','Joseilton'),(37,'Saco de lixo - 60 litros','pc c/ 5 unid',1,2,'2013-01-30 04:42:24','Joseilton'),(39,'Tapete de porta','unid',1,6,'2013-01-30 04:43:32','Joseilton'),(40,'Toalha de mão','unid',1,6,'2013-01-30 04:44:03','Joseilton'),(41,'Vaselina líquida','ml',200,6,'2013-01-30 04:44:03','Joseilton'),(42,'Vassoura de nylon','unid',1,4,'2013-01-30 04:44:32','Joseilton'),(43,'Vassoura de pelo','unid',1,4,'2013-01-30 04:44:58','Joseilton'),(44,'Vassoura de talo','unid',1,4,'2013-01-30 04:44:58','Joseilton'),(45,'Vassoura p/ vaso sanitário','unid',1,6,'2013-01-30 04:45:21','Joseilton'),(46,'Vassourão','unid',1,6,'2013-01-30 04:45:21','Joseilton'),(47,'Veja multiuso','ml',200,2,'2013-01-30 04:45:47','Joseilton'),(48,'Veneno p/ inseto – aerosol','unid',1,4,'2013-01-30 04:46:10','Joseilton'),(49,'Lixeira p/ Banheiro','litros',5,6,'2013-05-15 23:05:56','Joseilton'),(50,'Detergente limpa alumínio','ml',200,2,'2013-05-15 23:10:11','Joseilton'),(51,'Saco de Lixo - 15 litros','unid/pc',5,2,'2013-05-28 00:36:32','Joseilton'),(52,'Limpa vidro com gatilho','ml',500,2,'2013-08-13 21:45:52','Joseilton'),(53,'Adesivo sanitário','Unid',1,2,'2014-11-12 00:05:37','Joseilton');
...
INSERT INTO `nv_convert` VALUES (1,'Luciano Ferreira','Imaculada',512,'','2585','PB','Brasileira','','83-8727-6494','0000-00-00',0,'M','2009-09-19','','4037: Joseilton Costa Bruce','2009-10-04 18:17:10'),(2,'Eliabe Rodrigues','',331,'Sesi','2585','PB','Brasileira','','83-8873-9646','0000-00-00',0,'M','2009-09-19','','4037: Joseilton Costa Bruce','2009-10-04 18:18:17'),(3,'Rafaela de Oliveira Lima','Imaculada',1180,'','2585','PB','Brasileira','','83-8723-0854','0000-00-00',0,'F','2009-09-27','','4037: Joseilton Costa Bruce','2009-10-04 18:19:13'),(4,'Severina Anailma de Oliveira','Carlos Gomes',215,'','2585','PB','Brasileira','','83-8876-1334','0000-00-00',0,'F','2009-09-27','','4037: Joseilton Costa Bruce','2009-10-04 18:20:07'),(5,'Alex Martins Figueiredo','Rua: Rio do Meio',0,'','','PB','Brasileira','','83-9135-2874','0000-00-00',0,'M','2009-11-15','','4037: Joseilton Costa Bruce','2009-11-16 21:34:37'),(6,'Karolina de Onizio de Lima','Rua: Petronio Figueiredo',404,'Centro','','PB','Brasileira','83-3232-7297','','0000-00-00',1,'F','2009-11-15','Idade no dia em aceitou: 10 anos.','4037: Joseilton Costa Bruce','2009-11-16 21:36:46'),(7,'Rodrigo de Lima Campos','Rua: Petronio Figueiredo',404,'Centro','','PB','Brasileira','83-3232-7297','','0000-00-00',1,'M','2009-11-15','Idade no dia em que aceitou: 7 anos.','4037: Joseilton Costa Bruce','2009-11-16 21:38:16'),(8,'Ivanilda da Costa Pereira','Rua José Dias Vasconcelos',288,'','2585','PB','Brasileira','83-3232-2044','','0000-00-00',1,'F','2010-01-24','Informa a campnha de visita.','4037: Joseilton Costa Bruce','2010-01-24 23:42:00'),(9,'Valdemar Ferreira da Costa','Rua Monstriano Monteiro',239,'ALTO DA BOA VISTA','2585','PB','Brasileira','83- 873-4777','83-8745-4074','0000-00-00',0,'M','2010-04-21','','4037: Joseilton Costa Bruce','2010-04-22 00:17:13'),(10,'Maria Angélica da Silva Nascimento Santos','Rua Edvaldo M. de Oliveira 	Número:',78,'São Bento','2585','PB','Brasileira','8780 - 7916','','0000-00-00',1,'F','2010-04-25','Irmã de MARIA APARECIDA NASCIMENTO SANTOS, Rol: 4101','4037: Joseilton Costa Bruce','2010-04-26 00:40:48'),(11,'Stephanie Martins Ferreira','Rua da Aurora, Ap B',130,'Brasília','2585','PB','Brasileira','','83-8600-1393','0000-00-00',1,'F','2010-08-15','','4037: Joseilton Costa Bruce','2010-08-15 23:01:31'),(12,'Eva Maria do Nascimento Ramos','',0,'Aeroporto','2585','PB','Brasileira','','83-9925-3160','0000-00-00',3,'F','2010-08-15','','4037: Joseilton Costa Bruce','2010-08-15 23:02:41'),(13,'Tiago Fabrício de Oliveira','Rua Francisco Fernandes de Oliveira',498,'São Vicente','2585','PB','Brasileira','83-8860-7140','83-8860-7140','0000-00-00',12,'M','2010-09-05','','4037: Joseilton Costa Bruce','2010-09-06 00:30:54'),(14,'Edilson Souza Rufino','Rua Francisco Marques da Fonseca',675,'','2585','PB','Brasileira','','83 8713-3813','0000-00-00',1,'M','2010-11-21','','4037: Joseilton Costa Bruçe','2010-11-22 00:14:35');
...
INSERT INTO `organica` VALUES (1,0,'1',0,'Pastor Local','Pastor','Pastora','Direção Geral  ','','2011-09-19 00:38:17'),(2,1,'1.01.01.001',0,'Tesouraria Geral','1º Tesoureiro','1ª Tesoureira','Tesouraria Geral','','2011-09-19 00:13:58'),(3,1,'1.02.01.001',0,'Secretaria Executiva','1º Secretário','1ª Secretária','Secretaria Executiva','','2011-09-19 00:04:45'),(4,1,'1.03.01.001',0,'SEMADBY','1º Secretario','1ª Secretaria','Secretaria de Missões','','2011-09-19 00:04:45'),(5,1,'1.04.01.001',0,'USADEBY','Lider','Lider','União de Senhoras','','2011-09-19 00:04:45'),(6,1,'1.05.01.001',0,'UMADEBY','1º Secretario','1ª Secretaria','União da Mocidade','','2011-09-19 00:07:03'),(7,1,'1.06.01.001',0,'DEPIADBY','Coordenador','Coordenadora','Departamento Infatil','','2011-09-19 00:05:33'),(8,1,'1.07.01.001',0,'DEADBY','Coordenador','Coordenadora','Departamento de Ensino','','2011-09-19 00:05:33'),(9,1,'1.08.01.001',0,'DEMADBY','Coordenador','Coordenadora','Departamento de Música','','2011-09-19 00:05:33'),(11,1,'1.09.02.001',0,'Dir de Congregação','Dirigente','Dirigente','Dirigente de Congregação','','2009-12-30 14:17:54'),(12,2,'1.09.02.010',0,'Secretaria Executiva','','','Secretaria Executiva da Congregação','','2009-12-30 13:54:24'),(13,2,'1.09.02.005',0,'Tesouraria da Congregação','Tesoureiro','Tesoureira','Financeiro da Congregação','','2009-12-30 13:54:24'),(14,3,'1.03.06.001',0,'GEPA - Andreazza I','Coordenador','Coordenadora','Grupo de Envangelismo','','2009-12-30 13:54:24'),(15,3,'1.04.01.100',0,'Circulo de Oração','Dirigente','Dirigente','Circulo de Oração','','2009-12-29 03:18:07'),(16,3,'1.04.01.200',0,'Camp de Visitas','Dirigente','Dirigente','Campanha de Visitas','','2009-12-30 13:54:24'),(17,2,'1.05.01.110',0,'Setor I','Coordenador','Coordenadora','UMADEBY - Setor I','','2011-09-19 00:06:54'),(18,2,'1.05.01.120',0,'Setor II','Coordenador','Coordenadora','UMADEBY - Setor II','','2011-09-19 00:06:54'),(19,2,'1.05.01.130',0,'Setor III','Coordenador','Coordenadora','UMADEBY - Setor III','','2011-09-19 00:06:54'),(20,2,'1.05.01.140',0,'Setor IV','Coordenador','Coordenadora','UMADEBY - Setor IV','','2011-09-19 00:06:54'),(21,3,'1.06.01.100',0,'Dir de Crianças','Dirigente','Dirigente','Dirigente de Crianças da Congregação','','2009-12-30 14:15:58'),(22,2,'1.07.01.100',0,'Superintendente EB','Superintendente','Superintendente','Escola Bíblica Dominical','','2009-12-30 14:15:58'),(23,2,'1.08.01.170',0,'Coral Adulto','Dirigente','Dirigente','Coral Adulto da Congregação','','2009-12-30 14:15:58'),(24,2,'1.08.01.190',0,'Coral Jovem','Dirigente','Dirigente','Coral Jovem da Congregação','','2009-12-30 14:15:58'),(25,3,'1.06.01.200',0,'Soldadinhos de Cristo','Dirigente','Dirigente','Coral Infantil da Congregação','','2009-12-30 14:15:58'),(26,2,'1.08.01.210',0,'Conj Eletrônico','Dirigente','Dirigente','Conjunto Eletrônico da Congregação','','2009-12-30 14:15:58'),(27,1,'1.01.01.002',0,'Tesouraria Geral','2º Tesoureiro','2ª Tesoureira','Tesouraria Geral','','0000-00-00 00:00:00'),(28,1,'1.02.01.002',0,'Secretaria Executiva','2º Secretário','2ª Secretária','Secretaria Executiva','','0000-00-00 00:00:00'),(29,1,'1.02.01.003',0,'Secretaria Executiva','Secretário Adjunto','Secretária Adjunta','Secretaria Executiva','','0000-00-00 00:00:00'),(30,1,'1.10.01.001',0,'SEASADBY','1º Secretário','1ª Secretária','Secretaria de Ação Social','','2011-09-19 00:43:52'),(31,2,'1.04.01.002',0,'USADEBY','Coordenador','Coordenadora','União de Senhoras','','2011-09-24 02:09:12'),(32,2,'1.04.01.003',0,'USADEBY','Coordenador','Coordenadora','União de Senhoras','','2011-09-24 02:09:12'),(33,2,'1.08.01.100',0,'Asas da Alva','Dirigente','Dirigente','Conjunto Vocal','','2011-09-25 02:47:22'),(34,2,'1.08.01.150',0,'Primícias do Louvor','Dirigente','Dirigente','Conjunto eletrônico','','2011-09-25 02:47:22'),(39,2,'1.07.01.101',0,'Vice-Superintendente EB','Superintendente Substituto','Superintendente Substituta','Escola Bíblica Dominical','','2011-09-25 02:55:39'),(41,4,'1.09.02.020',0,'Portaria','Porteiro','Porteira','Porteiro da congregação','','2011-09-25 03:03:13'),(42,4,'1.09.02.021',0,'Limpeza','Zelador','Zeladora','Consevação e limpeza','','2011-09-25 03:03:13'),(43,3,'1.09.02.011',0,'Coral Adulto','Dirigente','Dirigente','Coral Adulto','','2011-09-26 03:13:32'),(44,3,'1.09.02.012',0,'Coral Jovem','Dirigente','Dirigente','Coral Jovem','','2011-09-26 03:13:32'),(47,3,'1.09.02.013',0,'Coral Infantil','Dirigente','Dirigente','Coral Infantil','','2011-09-26 03:15:46'),(48,3,'1.09.02.014',0,'Conjunto Eletrônico','Dirigente','Dirigente','Conjunto Eletrônico','','2011-09-26 03:15:46'),(49,4,'1.10.01.100',0,'Assistido da Ação Social','Assistido','Assistida','Oferta ou Auxílio','','2011-09-26 03:29:06'),(50,4,'1.09.02.022',0,'Segurança','Vigia','Vigia','Vigilância','','2011-09-26 18:39:58'),(53,2,'1.00.002',0,'Evangelista','Evangelista','Evangelista','Ministério de Evangelista','','0000-00-00 00:00:00'),(54,2,'1.00.003',0,'Presbiterio','Presbítero','Presbítero','Presbiterio','645.822.304-82','0000-00-00 00:00:00'),(55,2,'1.08.01.010',0,'Sonoplastia Templo Sede','Sonoplasta','Sonoplasta','Sonoplastia Templo Sede','','2011-09-28 13:14:04');
...
INSERT INTO `usuario` VALUES (1,'Admin','111.111.111-11',20,99,'Desenvolvedor do Sistema','21232f297a57a5a743894a0e4a801fc3',1,'','2015-07-20 18:22:44');
...
-- Dump completed on 2015-07-20 15:27:34
