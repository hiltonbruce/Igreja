	...
	<div class="row">
	  ...
	  <div class="col-xs-5">
			...
			<div class="btn-group" data-toggle="buttons">
				<label class="btn btn-primary <?php echo $SimplesC;?>">
					<input type="radio" name="tipo" value='1' <?php echo $Simples;?> >3 N&iacute;veis
				</label>
				<label class="btn btn-primary <?php echo $CompletoC;?>">
					<input type="radio" name="tipo" value='2' <?php echo $Completo;?> >2 N&iacute;veis
				</label>
				<label class="btn btn-primary <?php echo $ComadepC;?>">
					<input type="radio" name="tipo" value='4' <?php echo $Comadep;?> >COMADEP
				</label>
			</div>
	  </div>
	  <div class="col-xs-5">
