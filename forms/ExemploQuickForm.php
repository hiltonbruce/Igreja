...
<table border="0" cellpadding="0" cellspacing="2" bgcolor="#eeeeee" width="100%">
  <tr style="font-weight: bold;">' . createHeaderCell('QuickForm usando QuickHtml Renderer', 'center', 2) . '</tr>
  ...
  <tr>' . createHeaderCell('Autocompletar', 'left') .
          createHeaderCell('Teste AUTO', 'right') . '</tr>
          
  <tr>' . createFormCell($renderer->elementToHtml('iautoComp'), 'left') .'</tr>
