...
require "../func_class/classes.php";
	...
	$rec_ecl->c_impresso  = date("Y-m-d"); //Aqui È atribuido a esta vari·vel um valor para UpDate
	$rec_ecl->Update();
	
	$hist = $_SESSION['valid_user'].": ".$_SESSION['nome'];
	
	$atual = $rec_ecl -> hist ();
	$rec_ecl ->hist="@Impresso em: ". date ('d/m/Y H:i:s') .", por: $hist" . $atual ; //Aqui È atribuido a esta vari·vel um valor para UpDate
	$rec_ecl ->quem_imprimiu = $_SESSION['valid_user'];
	$rec_ecl->Update(); //… feita a chamada do mÈtodo q realiza a atualizaÁ„o no Banco
